...
public class PermissionRequester {
    ...
    public static void request(Context context, final OnSimplePermissionListener listener,
        String... permissions) {
        ...
        if (listener != null) {
            onPermissionListener = new OnPermissionListener() {
                ...
                public void onRequestPermission(boolean success,
                    ...
                    @Nullable List<String> rejectPermissions) {
    ...
    public static void requestForce(Context context, String permissionName,
    ...
    public static void requestForce(Context context, String permissionName,
        final OnSimplePermissionListener listener, String... permissions) {
        OnPermissionListener onPermissionListener = null;
        if (listener != null) {
            onPermissionListener = new OnPermissionListener() {
                @Override
    ...
    public static String[] checkSelfPermission(Context context, String... permissions) {
        ...
        return needRequest.toArray(
            new String[needRequest.size()]);//CommonUtil.toArray(rejectedPermissions);
    }

    // region 特殊权限
    public static void requestSpecialPermission(Context context, @NonNull String specialPermission,
        final OnSimplePermissionListener listener) {
    ...
    public interface OnPermissionListener {
         ...
         */
        void onRequestPermission(boolean success, @Nullable List<String> deniedPermissions,
            @Nullable List<String> rejectPermissions);
    }
